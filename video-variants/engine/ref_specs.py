...
Text is copied verbatim from each reference (including its spelling). `elements`
...
REFS = {
    "SEED-04": dict(
        ...
        text=dict(headline="IM 64", body="Here’s 7 habits\nthat made me\nhotter in my 60s\nthan in my 30s", cta=""),
    ...
    "SEED-05": dict(
        ...
        text=dict(headline="I'M 63", body="SECRET HABITS I STOLE FROM\nVICTORIA SECRET MODELS SINCE I\nWAS 32",
                  cta="(READ CAPTION)"),
    ...
    "SEED-06": dict(
        ...
        text=dict(headline="I'M 58", body="I've tried every\nf'cking thing to\nreverse my aging",
                  cta="Here's what\nactually worked 👇"),
    ...
    "SEED-07": dict(
        ...
        text=dict(headline="I’M 52", body="SECRET HABITS I STOLE FROM\nVICTORIA SECRET MODELS\nSINCE I WAS 32",
                  cta="(READ CAPTION)"),
